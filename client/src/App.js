...
function App() {
  const {iItems, newiItems, setiItems, setnewiItems, setNewItem, setNewPrice, setNewQuantity, itemList, showClicked, handleChange,handleChange2, addItem, getItemList, deleteItem, updateItem}=HandleStates();
